...
function initthreeLayer(){
     ...
     threeLayer = new maptalks.ThreeLayer('t', {
        ...
        var skybox = new THREE.Mesh(new THREE.CylinderGeometry(1, 1, 1000, 2), skyMaterial);
        skybox.fixed = true;
        ...
        window.animationLoop = () => {
            ...
            var cameraPosition = threeLayer.getCamera().position;
        ...
        threeLayer.prepareToDraw = function (gl, scene, camera) {
            ...
            camera.add(light);
            var ambientLight = new THREE.AmbientLight(0xe0e6e6); // soft blue-green light
