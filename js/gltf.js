	...
	function initScene() {
	    ...
	    defaultCamera = threeLayer.getCamera();
	    renderer = threeLayer.getThreeRenderer();
	    camera = defaultCamera;

	    var sceneInfo = {
	        name: "Police Car",
	        url: "./gltf/kdlk03/kdlk03.gltf",
	        objectPosition: new THREE.Vector3(-27591660.302791115, -16643057.24135378, -10),
	        addLights: true,
	        addGround: true,
	        shadows: true,
	    ...
	    loader.load(url, function (data) {
	        ...
	        // scene.add(object);
	        new ThreeGltfCar().addCar(object, testTrace2[0]);
	...
	var ThreeGltfCar = function () {
	    ThreeGltfCar.prototype.addCar = function (object, coords) {
	        ...
	        addToAnimationLoop(function () {
	            ...
	            object.rotation.y = Math.PI - pa.angle;
	        })
	    }

	    ThreeGltfCar.prototype._prepareData = function (coords) {
	        if (!coords) {
	            return;
	        }
	        var data = [];
	    ...
	    ThreeGltfCar.prototype._getPositionAndAngle = function (t) {
